...
//
// Nota: a propósito NO se incluye el sello de "abierto ahora". De este salón
// solo se conoce el horario del martes; con el resto de la semana en blanco el
// cartel diría "cerrado" cualquier otro día y eso le costaría clientas.
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* --- Formulario de cita -------------------------------------------------
     No manda correos ni guarda nada: junta lo que la clienta escribió y abre
  ...
  if (form) {
    ...
    const wsp = "51960613845";
    const encabezado = "Hola Osadia Salón Spa, vi su página web y quisiera pedir una cita:";
